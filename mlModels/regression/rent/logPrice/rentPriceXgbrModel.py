...
def rentPriceXgbrModel(df, drop_cols, accommodation="house", k=2):
    """
    ...
    drop_cols = ["finance_type", "is_wg", "log_wintergarden_size", "fgee", "is_phw", "wintergarden_ratio",
                 "estate_ratio", "is_geothermal", "is_ceiling", "is_bio", "is_electro",
                 "has_kitchen", "is_infrared", "is_oil", "is_gw", "is_air_heating", "is_gc", "is_central", "loc_4_0",
                 "garden_ratio", "has_loggia", "is_dgw", "has_garden",
    ...
    if CV:
        ...
        logging.info(f"-------[RENT] Cross Validation Scores for K={k}-------")
    ...
    logging.info(f"-------[RENT] XGBoost Regression Results for K={k}-------")
